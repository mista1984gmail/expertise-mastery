...
public class SortingComparator {
    ...
    private final static Comparator SORTING_EXPERTISE_BY_ID_DESC = Comparator.comparing(ExpertiseResponse::getId).reversed();
    ...
    private final static String SORTED_BY_ID_DESC= "sortedByIdDESC";
    ...
    public static Comparator sortingExpertiseInGroups(String condition){
        switch (condition){
            ...
            case SORTED_BY_ID_DESC:
                return SORTING_EXPERTISE_BY_ID_DESC;
